                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a class="btn btn-primary" href="{{ route('tag.create') }}"><i class="fas fa-plus-circle"></i></a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                            ...
                            <tbody>
                                @foreach ($tags as $tag)
                                    <tr>
                                        ...
                                        <td class="d-flex ">
                                            {{-- <a href="{{ route('tag.show', [$tag->id]) }}" class="btn btn-success btn-sm mr-1"><i class="fas fa-eye"></i></a> --}}
